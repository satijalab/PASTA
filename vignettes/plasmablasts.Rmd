...
remotes::install_github("satijalab/PASTA", ref="develop")
```

```{r load_libaries}
library(PASTA) #also loads Seurat and Signac
library(ggplot2)
...
[here](https://satijalab.github.io/azimuth/articles/run_azimuth_tutorial.html). 
...
#not that Azimuth provides higher-resolution annotations with 
